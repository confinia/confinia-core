...
| [#132](https://github.com/confinia/confinia-core/issues/132) | Transactional email | **ops alerts DONE and DELIVERED 2026-08-13**: a real firing rule sent `alert@confinia.io` → `contact@`, and the alert was true (green had been down 24 h). Registration confirmation still needs `verifyEmail` on the sandbox realm | **production** |
